...
export class SeatManager extends Component <{}, { selectedTool : ToolSelectionEnum, selectedItem : BaseItem | undefined, showContextMenu : boolean, contextMenuAnchorPoint : PositionType, currentZoom : number}>{
    private canvasRef : RefObject<HTMLCanvasElement>;
    private canvas : Canvas;
    private newElementCreating : BaseItem | undefined;
    private isMoving : boolean = false;
    private lastPositionInCanvas : PositionType | undefined;
    private placeMap : Array<BaseItem> = [];
    ...
    handleElementSelection = (clearSelection? : boolean) :void => {
        ...
        let selectedItemArray : Array<BaseItem> = this.placeMap.filter((currentItem) => {
    ...
    handleFinishCreation = (figureCreated : BaseItem) :void => {
        this.placeMap.push(figureCreated);
